...
-- Exibir nome e endereço de todos os clientes
-- select (pseudônimo.atributo)
-- from tabelaA pseudônimo
-- INNER JOIN tabelaB pseudônimo
-- on pseudônimo.pk = pseudônimo.fk;
